...
#define DEF_HANDLER_TABLE(level,label)               \
    HANDLER_TABLE_T *TBL_NAME(level,label)[] = {     \
        ...
        L(OPC_ONE_MORE,               level, label), \
        L(OPC_ELITE_OPS,              level, label), \
        L(OPC_SAFE_DIV,               level, label), \
        L(OPC_REVERSE_DIV,            level, label), \
        L(OPC_SUM_SQUARES,            level, label), \
        L(OPC_SUM_FABONACCI,          level, label), \
        L(OPC_CRASH_AND_BURN,         level, label), \
        &&unused,                                    \
        &&unused,                                    \
        &&unused,                                    \
        &&unused,                                    \
